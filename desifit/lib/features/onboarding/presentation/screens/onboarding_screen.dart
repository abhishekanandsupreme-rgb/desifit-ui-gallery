...
import '../widgets/onboarding_intro_pages.dart';
...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  Widget _buildIntroPage(BuildContext context) =>
      buildOnboardingIntroPage(context);
  Widget _buildPage1(BuildContext context) => buildOnboardingPage1(context);
  Widget _buildPage2(BuildContext context) => buildOnboardingPage2(context);
  Widget _buildPage3(BuildContext context) => buildOnboardingPage3(context);
  Widget _buildPage4(BuildContext context) => buildOnboardingPage4(context);
